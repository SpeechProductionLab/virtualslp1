...
var task1 = $('#task1-instruction');
var task2 = $('#task2-instruction');
var task3 = $('#task3-instruction');
instructionsButton(task1, ".task1-button", "nextBtn5");
instructionsButton(task2, ".task2-button", "nextBtn7");
instructionsButton(task3, ".task3-button", "nextBtn9");
function instructionsButton(taskSpecified, buttonClass, nextClass) {
	$(buttonClass).on('click', function(){
		taskSpecified[0].play();
		$(buttonClass).removeAttr('id');
		$(buttonClass).attr('id', 'pauseBtn');
	});
	taskSpecified.on('ended', function(){
		$(buttonClass).removeAttr('id');
		$(buttonClass).attr('id', 'readBtn');
		taskSpecified[0].currentTime = 0;
