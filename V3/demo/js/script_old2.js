...
//task2.stop();
//task3.stop();
var buttonClass1 = document.querySelector('.task1-button');
var buttonClass2 = document.querySelector('.task2-button');
var buttonClass3 = document.querySelector('.task3-button');
